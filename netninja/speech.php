                ...
                <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e5e4e3 ;">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <ul class="navbar-nav ml-auto">
                                <li class="nav-item active">
                                    <a class="nav-link" href="index.html">Cerrar session <span class="sr-only"></span></a>
                                </li>
                                ...
                                <!-- <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item">formularios</a> -->
                
                
                                        <!-- dropdown-divider -->
                                        <!-- <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="solapp.html">Solicitud de apoyo</a>
                                        <a class="dropdown-item" href="callscript.html">Speech de llamadas</a>
                                        <a class="dropdown-item" href="busqueda.html">Busqueda de caso</a>
                                        <a class="dropdown-item" href="ingcaso.html">Ingresar caso</a>
                                ...
                                <!-- dropdown-menu  Cerrar Session/Iniciar-->
                                <!-- <li class="nav-item dropdown">
                
                
                                    <a class="nav-link dropdown-toggle" href="######" id="navbarDropdown" role="button" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false"><b>Cerrar Session</b> <span class="caret"></span></a>
                                    <div class="dropdown-divider"></div>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <!-- dropdown-divider -->
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item logged-in" style="display: none;" href="index.html">Cerrar Session</a>
                                        <!-- <a class="dropdown-item logged-out" style="display: none;" href="iniciar.html">Iniciar</a> -->
